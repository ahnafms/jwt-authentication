    ...
    <main className="h-screen w-full flex-col flex justify-center items-center">
      <div className="flex flex-col justify-center items-start gap-y-5 p-9 rounded-xl border-slate-800 border-2">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-y-3">
          ...
          <input {...register("nama")} type="text" id="nama" className="px-4 py-2 rounded-sm"/>
          <label htmlFor="password">Password</label>
          <input {...register("password")} type="text" id="password" className="px-4 py-2 rounded-sm"/>
          <label htmlFor="email">Email</label>
          <input {...register("email")} type="text" id="email" className="px-4 py-2 rounded-sm" />
